...
import { borderWidthThin, spacingStaticXs, colorSuccess, colorPrimary, colorContrastLower, colorFrostedSoft, colorSuccessFrostedSoft, colorSuccessLow, pdsSwitchInsetCompact, pdsSwitchHeightCompact, pdsSwitchWidthCompact } from '../styles.mjs';
...
const toggleButtonStyleCompact = createPart({
...
export { toggleButtonStyle, toggleButtonStyleCompact };
